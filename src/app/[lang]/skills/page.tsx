...
export default function SkillsPage() {
    const skills = [
        ...
        { name: "Lint-staged", icon: <SiEslint className="text-purple-600" size={40}/> },
        { name: "Prisma", icon: <SiPrisma className="text-black dark:text-white" size={40}/> },
        { name: "Nx", icon: <SiNx className="text-yellow-700" size={40}/> },
        { name: "Kubernetes", icon: <SiKubernetes className="text-blue-500" size={40}/> },
    ];
